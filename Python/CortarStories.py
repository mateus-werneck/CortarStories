...
class Panel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        text = wx.StaticText(self, label="Arraste o seu arquivo para cá: ")
        ...
        self.button1 = wx.Button(self, ID_START, label='Começar', size=(50, 30))
        self.button2 = wx.Button(self, ID_STOP, label='Cancelar',  size=(50, 30))
...
class Frame(wx.Frame):
    ...
    def MessageErro(self):
        wx.MessageBox('Nenhum arquivo foi inserido.', 'Erro',
        wx.OK | wx.ICON_INFORMATION)
    ...
    def OnResult(self, event):
        ...
        if event.data is None:
            self.SetStatusText('Conversão abortada')
        else:
            self.SetStatusText('Conversão concluída.')
            self.MessageSave()
        self.worker = None
    ...
    def OnStop(self, event):
        """Stop Computation."""
        if self.worker:
            self.SetStatusText('Abortando o conversor...')
            time.sleep(2)
            self.worker.abort()            
#----------------------------------------------------------------------
